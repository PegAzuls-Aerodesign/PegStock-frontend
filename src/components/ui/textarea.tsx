    ...
    return (
      <textarea
        className={cn(
          ...
          "focus-visible:ring-brand-green-200 focus-visible:ring-2 focus-visible:ring-offset-0 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
          className,
        )}
        ref={ref}
        {...props}
