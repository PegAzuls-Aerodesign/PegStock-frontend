...
>(
  (
    ...
    const [, setDialogEl] = useDialogContext();
...
type DialogContextType = ReturnType<
  typeof React.useState<React.ElementRef<typeof DialogPrimitive.Content>>
>;
...
export const Dialog: typeof DialogRoot = (props) => {
  const state =
    React.useState<React.ElementRef<typeof DialogPrimitive.Content>>();
